// this file checks whether RandomNumberConsumer should be deployed locally or whatever chain
...
module.exports = async ({
  ...
  if (chainId == 31337) {
    linkToken = await get('LinkToken') // it's not the file name of the .sol file that matters, it's the name of the contract in the file
